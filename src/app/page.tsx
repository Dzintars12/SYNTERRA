import synterraSymbol from "../../SYNTERRA.png";
    ...
    <main className="synterra-home">
      <style>{`
        .synterra-home {
          ...
          background:
            radial-gradient(circle at center, rgba(245, 180, 85, 0.15), transparent 38%),
            radial-gradient(circle at center, rgba(255, 210, 120, 0.08), transparent 64%),
            #030303;
          color: white;
        ...
        .synterra-symbol-image {
          ...
          opacity: 0.9;
          filter:
            drop-shadow(0 0 34px rgba(255, 190, 85, 0.42))
            drop-shadow(0 0 92px rgba(255, 160, 50, 0.22));
          animation: synterraRotate 160s linear infinite;
        ...
        .synterra-core-pulse {
          ...
          border-radius: 999px;
          background: rgba(255, 222, 150, 0.92);
          box-shadow:
            0 0 24px rgba(255, 231, 175, 1),
            0 0 80px rgba(255, 190, 80, 0.64);
          animation: synterraPulse 5.5s ease-in-out infinite;
          pointer-events: none;
        }
      ...
      <img className="synterra-symbol-image" src={synterraSymbol.src} alt="SYNTERRA symbol" />
      <div className="synterra-core-pulse" />
      ...
      <section className="synterra-content">
        ...
        <div className="synterra-status">System status: online · Consciousness centered</div>
      </section>
    </main>
  );
}
